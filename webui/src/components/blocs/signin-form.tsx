    ...
    <form className="space-y-4" onSubmit={handleSubmit}>
      ...
      <div className="space-y-1">
        ...
        <Input
          ...
          className="py-6 px-5 rounded-xl"
        />
      </div>
      ...
      <div className="flex items-center justify-between gap-y-2">
        <div className="flex items-center gap-3">
          <Checkbox
            id="rememberMe"
            className="cursor-pointer size-4 rounded-sm md:size-6 md:rounded-lg"
          />
          <Label
            htmlFor="rememberMe"
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col w-full gap-4">
          <Button
            variant={"outline"}
            className="cursor-pointer flex items-center rounded-full py-6 gap-5 w-full"
            onClick={() =>
          ...
          >
            ...
            <p className="block font-lg">Continue with google</p>
          </Button>
          <Button
            variant={"outline"}
            className="flex items-center cursor-pointer rounded-full py-6 gap-5 w-full"
            onClick={() =>
              signIn.authenticateWithRedirect({
          ...
          >
            ...
            <p className="block font-lg">Continue with Apple</p>
          </Button>
          <Button
            variant={"outline"}
            className="cursor-pointer flex items-center rounded-full py-6 gap-5 w-full"
          ...
          >
            ...
            <p className="block font-lg">Continue with Meta</p>
          </Button>
        </div>
      </div>
    </form>
